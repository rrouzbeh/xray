...
def gen_vless_qr_code(server_config):
    # Generate vless:// link
    vless_link = f"vless://{server_config['user_id']}@{server_config['address']}:{server_config['port']}?type=ws&security=tls&path=%2F&host={server_config['tls_server_name']}&sni={server_config['tls_server_name']}#vless-3"
    # Generate QR code
